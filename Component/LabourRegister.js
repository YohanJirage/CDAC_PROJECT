        ...
        <div className="container">
            <form>
                <div>
                    ...
                    <input type="text" id="fname" name="fname" value={info.fname.value} onChange={(e)=>{handleChange("fname",e.target.value)}}/>
                </div>
                <div>
                    <label htmlFor="lname">Enter Last name</label>
                    <input type="text" id="lname" name="lname" value={info.lname.value} onChange={(e)=>{handleChange("lname",e.target.value)}}/>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" id="exp" name="exp" value={info.exp.value} onChange={(e)=>{handleChange("exp",e.target.value)}}/>
                </div>
                <div>
                    <label htmlFor="stat">Enter Status of availability</label>
                    <input type="text" id="stat" name="stat" value={info.stat.value} onChange={(e)=>{handleChange("stat",e.target.value)}}/>
                </div>
